...
# train
python -m run.train dir=local exp_name=exp001 is_lgb_only=true version=v1
# simple train
python -m run.train dir=local exp_name=exp030 is_lgb_only=true whole_training=false version=v1
...
python3.10 -m run.train dir=paperspace env=paperspace exp_name=exp001 is_lgb_only=true version=v1
```
